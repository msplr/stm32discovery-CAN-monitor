...
#define LED_RED(x) {if (x) palSetPad(GPIOE, GPIOE_LED10_RED); else palClearPad(GPIOE, GPIOE_LED10_RED);}
#define LED_GREEN(x) {if (x) palSetPad(GPIOE, GPIOE_LED7_GREEN); else palClearPad(GPIOE, GPIOE_LED7_GREEN);}
#define LED_BLUE(x) {if (x) palSetPad(GPIOE, GPIOE_LED9_BLUE); else palClearPad(GPIOE, GPIOE_LED9_BLUE);}
#define LED_ORANGE(x) {if (x) palSetPad(GPIOE, GPIOE_LED8_ORANGE); else palClearPad(GPIOE, GPIOE_LED8_ORANGE);}
